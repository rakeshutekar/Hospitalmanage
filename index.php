		...
		<!--start-wrap-->
			...
			<div class="header">
				...
				<div class="logo">
					...
					<a href="index.php" style="font-size: 30px;font-family:sans-serif, monospace; color: blue;">Cloud Nine Hospital</a>
				</div>
				<!--end-logo-->
				<!--start-top-nav-->
				<div class="top-nav">
		    ...
		    <div class="content-grids">
				...
				<div class="listview_1_of_3 images_1_of_3">
					<div class="listimg listimg_1_of_2">
						  <img src="img/14.png" height="100px" width="100px">
					</div>
				...
				<div class="listview_1_of_3 images_1_of_3">
					<div class="listimg listimg_1_of_2">
						  <img src="img/13.png" height="100px" width="100px">
					</div>
					<div class="text list_1_of_2">
						  <h3>Patients</h3>
				...
				<div class="listview_1_of_3 images_1_of_3">
					<div class="listimg listimg_1_of_2">
						  <img src="img/12.png" height="100px" width="100px">
					</div>
					<div class="text list_1_of_2">
						  <h3>Doctors Login</h3>
